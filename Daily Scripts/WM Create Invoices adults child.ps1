...
$csvclient = 'c:\userdata\circe launches\invwm\inv20oct.csv' #Input csv file
...
$outfile2 = 'c:\userdata\circe launches\invwm\WMinv20oct.txt'  #File to be imported into Pastel
