...
$csvclient = 'c:\userdata\circe launches\invwm\vch19oct.csv' #Input csv file
...
$outfile2 = 'c:\userdata\circe launches\invwm\WMvch19oct.txt'  #File to be imported into Pastel
