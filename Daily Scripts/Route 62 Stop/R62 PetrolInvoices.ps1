...
#>
$csvclient = 'C:\userdata\route 62\petrol books\all2506.csv'      #Input from Client spreadsheet
$outfile = 'C:\userdata\route 62\petrol books\petrolinv.txt'        #Temp file
$outfile2 = 'C:\userdata\route 62\petrol books\all2506.txt'     #File to be imported into Pastel
