...
$outfile2 = 'C:\userdata\Route 62\_aLL suppliers\suppliers mixed vat inv july 2020_1.csv'
$outfileF = 'C:\userdata\route 62\_All Suppliers\Suppliers july mixed vat 2020_1.txt'     
