...
$inspreadsheet = 'C:\userdata\route 62\_all suppliers\suppliers May 2020.xlsm'        #Change each month
$csvfile = 'suppliers_1.csv'                            #Temp file
$pathout = 'C:\userdata\route 62\_all suppliers\'
$custsheet = 'May 20'                          #Customer worksheet - change each month
$outfile2 = 'C:\userdata\Route 62\_all suppliers\suppliers may 2020.csv' #Change each month
