...
$csvclient = 'C:\Userdata\GUY\_SARS\2019\statements\bank transactions\f360t.csv'                  
#Temp file
...
$outfileF1 = 'C:\Userdata\GUY\_SARS\2019\statements\bank transactions\f360tR.txt'       #Receipts           
$outfileF2 = 'C:\Userdata\GUY\_SARS\2019\statements\bank transactions\f360tP.txt'       #Payments            
    ...
    Switch ($aObj.type) {
        r {  
            ...
            $props1 = [ordered] @{
                ...
                fil3    = ' '
                fil4    = '     '
                fil5    = '8410000'                #Bank account number
                fil6    = '1'
                fil7    = '1'
                fil8    = '0'
                fil9    = '0'
